"""
Contains functions to parse docstring sections and convert to MDX.
...
def args(content:str) -> Tuple[str, str]:
    ...
    for line in lines:
        ...
        # If this line doesn't begin with an argument
            ...
            assert len(line) >= len(this_indentation) and line[0:len(this_indentation)] == this_indentation
