"""
Validates Python docstrings according to the Google style and outputs to MDX.

References:
    This implementation is based on the following docs,
        * PEP 257: https://www.python.org/dev/peps/pep-0257/
        * Google Python Style Guide: https://google.github.io/styleguide/pyguide.html#38-comments-and-docstrings
        * sphinxcontrib.napoleon package: https://sphinxcontrib-napoleon.readthedocs.io/en/latest/index.html#id1
...
from .example_docstrings import *
...
class Docstring(object):
    ...
    """
    def __init__(self, docstring, throw_warnings=False):
        # Save raw docstring
        ...
        for jdx in range(idx, len(blocks)):
            ...
            if re_section_header.fullmatch(block_lines[0]):
                ...
                if len(section_blocks) and len(section):
                    ...
                    normalized_section, markdown = valid_headers[section](content)
    ...
    def to_mdx(self) -> str:
        ...
        if self._markdown is None:
            ...
            for section in ['args', 'attributes', 'returns', 'yields', 'raises', 'example', 'see_also', 'todo', 'references']:
