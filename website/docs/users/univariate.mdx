...
flow = bijectors.Exp()
```
The class `bijectors.Exp` derives from `flowtorch.bijectors.Bijector` and defines the forward, inverse, and log-absolute-derivative operations for this transform,
